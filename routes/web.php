...
Route::namespace('Web')->group(function () {
    ...
    // Shop Routes - Public Ecommerce
    Route::get('/shop', 'ShopController@index')->name('shop.index');
    Route::get('/shop/fetch', 'ShopController@fetchProducts')->name('shop.fetch');
    Route::get('/shop/product/{id}', 'ShopController@show')->name('shop.show');
    ...
    // Company Store - For owners to browse products from Super Admin market
    Route::get('/company/store', 'ShopController@index')->name('company.store')->middleware('auth:web');
    
    // Company Shop - Requires authentication (redirect to company dashboard shop)
    Route::get('/company-shop', function() {
        return redirect()->route('company.shop.index');
    })->name('company.shop.redirect');
