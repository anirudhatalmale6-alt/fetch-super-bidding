...
// Market Routes (Admin E-commerce Management)
Route::middleware('auth:web')->namespace('Admin')->group(function () {
    Route::prefix('market')->group(function () {
        Route::get('/', 'MarketController@index')->name('market.index');
        Route::get('/fetch', 'MarketController@fetch')->name('market.fetch');
        Route::get('/create', 'MarketController@create')->name('market.create');
        Route::post('/store', 'MarketController@store')->name('market.store');
        Route::get('/edit/{product}', 'MarketController@edit')->name('market.edit');
        Route::put('/update/{product}', 'MarketController@update')->name('market.update');
        Route::delete('/delete/{product}', 'MarketController@destroy')->name('market.destroy');
        Route::post('/toggle-status/{product}', 'MarketController@toggleStatus')->name('market.toggle-status');
        Route::post('/toggle-featured/{product}', 'MarketController@toggleFeatured')->name('market.toggle-featured');
        Route::post('/{product}/delete-image', 'MarketController@deleteImage')->name('market.delete-image');
    });
});
...
Route::middleware('auth:web')->namespace('Admin')->group(function () {
    Route::prefix('banners')->group(function () {
        ...
        Route::get('/fetch', 'BannerController@fetch')->name('banners.fetch');
        ...
        Route::put('/update/{banner}', 'BannerController@update')->name('banners.update');
        Route::delete('/delete/{banner}', 'BannerController@destroy')->name('banners.destroy');
        Route::post('/toggle-status/{banner}', 'BannerController@toggleStatus')->name('banners.toggle-status');
        Route::post('/update-sort-order', 'BannerController@updateSortOrder')->name('banners.update-sort-order');
    });
});

// Company Store Routes - Simple auth middleware for all logged in users
Route::middleware('auth:web')->namespace('Admin\Company')->group(function () {
    Route::prefix('company-store')->group(function () {
        Route::get('/', 'StoreController@index')->name('company.store.index');
        Route::get('/fetch', 'StoreController@fetchProducts')->name('company.store.fetch');
        Route::get('/product/{product}', 'StoreController@show')->name('company.store.show');
        Route::get('/banner', 'StoreController@getBanner')->name('company.store.banner');
    });
});
