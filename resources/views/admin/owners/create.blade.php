                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-3">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="card company-type-card" data-value="fleet" style="cursor: pointer; border: 2px solid transparent;">
                                            <div class="card-body text-center">
                                                <input type="radio" name="company_type" value="fleet" style="display: none;" {{ old('company_type', 'fleet') == 'fleet' ? 'checked' : '' }}>
                                                <i class="fa fa-taxi fa-2x text-primary mb-2"></i>
                                                <h6>Fleet Only</h6>
                                                <small class="text-muted">Taxi/Delivery services only</small>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="card company-type-card" data-value="trucking" style="cursor: pointer; border: 2px solid transparent;">
                                            <div class="card-body text-center">
                                                <input type="radio" name="company_type" value="trucking" style="display: none;" {{ old('company_type') == 'trucking' ? 'checked' : '' }}>
                                                <i class="fa fa-truck fa-2x text-info mb-2"></i>
                                                <h6>Trucking</h6>
                                                <small class="text-muted">Interstate logistics only</small>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="card company-type-card" data-value="both" style="cursor: pointer; border: 2px solid transparent;">
                                            <div class="card-body text-center">
                                                <input type="radio" name="company_type" value="both" style="display: none;" {{ old('company_type') == 'both' ? 'checked' : '' }}>
                                                <i class="fa fa-road fa-2x text-success mb-2"></i>
                                                <h6>Both Services</h6>
                                                <small class="text-muted">Fleet + Trucking services</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    document.querySelectorAll('.btn-file input[type="file"]').forEach((input) => {
        ...
        // Company type card selection
        $('.company-type-card').on('click', function() {
            $('.company-type-card').removeClass('border-success').css('border-color', 'transparent');
            $(this).addClass('border-success').css('border-color', '#28a745');
            $(this).find('input[type="radio"]').prop('checked', true);
        });

        // Initialize selected card
        var selectedType = $('input[name="company_type"]:checked').val();
        if(selectedType) {
            $('.company-type-card[data-value="' + selectedType + '"]').addClass('border-success').css('border-color', '#28a745');
        }
    </script>
@endsection
