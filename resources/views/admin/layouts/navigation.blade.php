...
<!--     @if(auth()->user()->can('view-email-templates'))
     ...
     @if(auth()->user()->can('drivers-menu'))
      ...
      <!-- Market/E-commerce Menu -->
      <li class="treeview {{ 'market' == $main_menu ? 'active menu-open' : '' }}">
        <a href="javascript: void(0);">
        ...
        <ul class="treeview-menu">
          <li class="{{ 'market_products' == $sub_menu ? 'active' : '' }}">
            <a href="{{url('/market')}}"><i class="fa fa-circle-thin"></i>Products</a>
          </li>
          <li class="{{ 'market_create' == $sub_menu ? 'active' : '' }}">
            <a href="{{url('/market/create')}}"><i class="fa fa-circle-thin"></i>Add Product</a>
          </li>
          <li class="{{ 'banners' == $sub_menu ? 'active' : '' }}">
            <a href="{{url('/banners')}}"><i class="fa fa-circle-thin"></i>Banners</a>
          </li>
        </ul>
      </li>

      <!-- Company Store Menu (for Fleet Owners) -->
      @if(auth()->user()->hasRole('owner') || auth()->user()->can('access-company-store'))
      <li class="{{'company_store' == $main_menu ? 'active' : '' }}">
        <a href="{{url('/company/store')}}">
          <i class="fa fa-store"></i> <span> Equipment Store </span>
        </a>
      </li>
      @endif
