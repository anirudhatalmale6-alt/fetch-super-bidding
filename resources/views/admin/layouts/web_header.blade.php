    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse order-md-3" id="navbarLandingCollapse">
        ...
        <ul class="navbar-nav nav-divided ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link services" style="color:{{ $data->menutextcolor }} !important;" href="{{ url('services') }}">Services</a>
          </li>
          <li class="nav-item">
            <a class="nav-link contact" style="color:{{ $data->menutextcolor }} !important;" href="{{ url('contactus') }}">Contact</a>
          </li>
          <li class="nav-item">
            <a class="nav-link shop" style="color:{{ $data->menutextcolor }} !important;" href="{{ route('shop.index') }}">
